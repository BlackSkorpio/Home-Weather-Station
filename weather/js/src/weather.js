	...
	*/
	...
	switch ( langCode ) {
		case "se":
			...
			moonPhasesTxt	= "Månfas: ";
			moonPhasesDesc	= "Månens faser beror på positionen av både solen och månen i förhållande till jorden. När månen kretsar kring jorden förändras månens utseende beroende av hur ljuset från solen reflekteras av månens yta. Förändringen ger oss en indikation på månens framsteg i måncykeln, så kallade månfaser.";
			sunCalcHour		= "Tidsplan";
			sunCalcCord		= "Sol & Mån Data";
		...
		default:
			...
			moonPhasesTxt	= "Lunar Phase: ";
			moonPhasesDesc	= "The lunar phase or phase of the Moon is the shape of the directly sunlit portion of the Moon as viewed from Earth. The lunar phases gradually and cyclically change over the period of a synodic month (about 29.53 days), as the orbital positions of the Moon around Earth and of Earth around the Sun shift.<br />The Moon's rotation is tidally locked by Earth's gravity; therefore, most of the same lunar side always faces Earth. This near side is variously sunlit, depending on the position of the Moon in its orbit. Thus, the sunlit portion of this face can vary from 0% (at new moon) to 100% (at full moon). The lunar terminator is the boundary between the illuminated and darkened hemispheres.";
			sunCalcHour		= "Schedule";
			sunCalcCord		= "Sun & Moon Data";
			sunRiseTxt		= "Sunrise: ";
